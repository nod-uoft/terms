...
gem 'kmaps_engine',               '7.0.9',        github: 'shanti-uva/kmaps_engine',         tag: 'v7.0.9' #path: '../../shanti/engines/kmaps_engine'
...
gem 'shanti_integration',         '3.7.2',        github: 'shanti-uva/shanti_integration',   tag: 'v3.7.2' #path: '../../shanti/engines/shanti_integration'
...
gem 'terms_engine',               '2.1.5',        github: 'shanti-uva/terms_engine',         tag: 'v2.1.5' #path: '../../shanti/engines/terms_engine'
