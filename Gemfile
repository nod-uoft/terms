...
gem 'authenticated_system',       '2.6.1',        github: 'thl/authenticated_system',        tag: 'v2.6.1' #path: '../../thl/engines/authenticated_system'
...
gem 'kmaps_engine',               '7.0.8',        github: 'shanti-uva/kmaps_engine',         tag: 'v7.0.8' #path: '../../shanti/engines/kmaps_engine'
...
gem 'shanti_integration',         '3.7.1',        github: 'shanti-uva/shanti_integration',   tag: 'v3.7.1' #path: '../../shanti/engines/shanti_integration'
gem 'nod_integration',            '0.1.3',        github: 'nod-uoft/nod_integration',        tag: 'v0.1.3' #path: '../engines/nod_integration'
...
gem 'terms_engine',               '2.1.1',        github: 'shanti-uva/terms_engine',         tag: 'v2.1.1' #path: '../../shanti/engines/terms_engine'
