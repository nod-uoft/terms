...
gem 'shanti_integration',         '3.7.0',        github: 'shanti-uva/shanti_integration',   tag: 'v3.7.0' #path: '../../shanti/engines/shanti_integration'
gem 'nod_integration',            '0.1.0',        github: 'nod-uoft/nod_integration',        tag: 'v0.1.0' #path: '../engines/nod_integration'
